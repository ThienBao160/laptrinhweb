                                ...
                                <div class="form-group mb-2">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-8" style="text-align: left; margin-bottom: 10px;">
                                            <input type="text" id="name" style="border: solid 1px; width: 215px;"
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-8" style="text-align: left;">
                                                <input type="text" id="email_address"
                                                    style="border: solid 1px; width: 215px;" name="email" required
                                                    autofocus>
                                                @if ($errors->has('email'))
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-8" style="text-align: left;">
                                                <input type="password" id="password"
                                                    style="border: solid 1px; width: 215px;" name="password" required>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-8" style="text-align: left;">
                                                <input type="password" id="confirmPassword"
                                                    style="border: solid 1px; width: 215px;" name="confirmPassword"
                                                    required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8" style="text-align: right; margin-top: 6px;">
                                            <a href="#"
                                                style="text-align: right; text-decoration: none; font-size: 13px;">Bạn đã có
                                                tài khoản?</a>
                                        </div>
                                        <div class="col-md-4" style="padding-left: 5px;">
                                            <div class="" style="text-align: left; ">
                                                <button type="submit" class="btn btn-dark btn-block"
                                                    style=" margin-left: 11px;">Đăng kí</button>
                                            </div>
